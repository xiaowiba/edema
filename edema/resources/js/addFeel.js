edemaApp.controller('addFeelController', function ($scope, $state, $http, $filter, $timeout, $sce) {
    ...
    $scope.INIT = function () {
        ...
        $.ajax({
            ...
            success:function (data) {
                ...
                //key
                $scope.accessKey = $scope.data.accessKey;
    ...
    $scope.submit = function () {
        ...
        $.ajax({
            async: true,
            method: 'post',
            url: $scope.addaUrl + '/rest/lymphedema/' + $scope.accessKey + '/feel/wx',
            data:{
            ...
            success:function (data) {
                ...
                if($scope.result === 200){
                    //mui.toast('添加成功');
                    setTimeout(function () {
                        window.location.href = 'index.html?account=' + $scope.account + '&openId=' + $scope.openId;
                    }, 0);
            ...
            IScroll.prototype = {
                ...
                _translate: function(x, y) {
                    if (this.options.useTransform) {
                        ...
                        var _tid = document.getElementById('painRes');
                        var painResInput = $('#painResInput');
                        ...
                        if (_x <= 0) {
                            if (_x == 0) {
                                ...
                                _tid.innerHTML = ((((-parseFloat(x / 5)) * 10) / 100) - 0.6).toFixed(1);
                                painResInput.val( ((((-parseFloat(x / 5)) * 10) / 100) - 0.6).toFixed(1) );
                                console.log(((((-parseFloat(x / 5)) * 10) / 100) - 0.6).toFixed(1));
                            } else {
                                _tid.innerHTML = 10;
                                painResInput.val(10);
                            }
    ...
    //滑动尺子过程中的回调函数
    function rulerSetValue () {

        var val = (parseFloat($('#painResInput').val())).toFixed(1);
